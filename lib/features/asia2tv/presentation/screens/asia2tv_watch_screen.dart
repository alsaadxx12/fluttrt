                  ...
                  if (_servers.length > 1) ...[
                    ...
                    Row(
                      children: [
                        ...
                        const Text('السيرفرات:', style: TextStyle(color: Colors.white70, fontSize: 12, fontWeight: FontWeight.bold)),
                        const SizedBox(width: 8),
                        Expanded(
                                  ...
                                  Padding(
                                    ...
                                    child: ChoiceChip(
                                      ...
                                      labelStyle: TextStyle(
                                        color: _activeServer.toLowerCase().contains(s.name.toLowerCase()) ? Colors.white : Colors.white60,
                                        fontWeight: FontWeight.bold,
                                      ),
                                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)),
                                      side: BorderSide(
                                        color: _activeServer.toLowerCase().contains(s.name.toLowerCase()) ? AppColors.primary : Colors.white12,
                                      ),
                                      onSelected: (_) {
