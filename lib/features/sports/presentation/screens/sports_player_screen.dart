...
<body>
  ...
  Future<void> _setupChannelsAndStream() async {
    ...
    if (channelList.isEmpty) {
      try {
        ...
        debugPrint('[SPORTS_PLAYER] Dynamic stream lookup error: $e');
      }
    }
  ...
  Future<void> _castChannel(PlayerChannelItem channel) async {
    ...
    debugPrint('[cast] match channel ${channel.id}: '
        'web=${channel.isWebStream} url=${url == null || url.isEmpty ? "-" : url.split("?").first}');
