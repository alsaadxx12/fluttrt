...
class AppTheme {
  ...
  static String? _fontFamilyFor(AppLanguage language) =>
      language == AppLanguage.arabic ? arabicFamily : null;
  ...
  static ThemeData lightTheme(AppLanguage language) => darkTheme(language);

  static ThemeData darkTheme(AppLanguage language) {
    final textTheme = _getTextTheme(
        language, Brightness.dark, AppColors.darkTextPrimary, AppColors.darkTextSecondary);
