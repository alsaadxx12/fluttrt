...
class _AppDrawerState extends ConsumerState<AppDrawer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Drawer(
      ...
      elevation: 0,
      // No backdrop blur: the renderer ran it on every frame of the slide.
      child: ClipRect(
        child: Container(
                ...
                Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      // ...and sits beside the close button at the end: the start
                      // corner is where the profile button that opens the drawer
                      // was, and a second tap there must not flip the theme.
                      Align(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    shape: BoxShape.circle,
                                    border: isDark ? null : Border.all(color: palette.border, width: 1),
                                  ),
                                  child: Icon(
                                    Icons.menu_rounded,
                                    size: 18,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  userProfile?.fullName.isNotEmpty == true ? userProfile!.fullName : 'مستخدم CineBall',
                                  style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w900,
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: isDark ? Colors.white.withOpacity(0.12) : const Color(0xFF1E293B),
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _DrawerItem(
                        ...
                        title: 'المباريات',
                        badgeText: null,
                        isSelected: currentPath == '/sports' || currentPath == '/sports-activation',
                        onTap: () {
                          Navigator.pop(context);
                          if (isSportsUnlocked) {
                            context.push('/sports');
